...
/**
 * Mail Setting Page of MobileTester
 **/
public class MailSettingsActivity extends Activity {

	private static final String LOG_TAG = "MobileTester-" + MailSettingsActivity.class.getSimpleName();
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		final EncryptData des = new EncryptData("MobileTester");
