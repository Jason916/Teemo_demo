...
import com.example.jasonxu.mobiletester.service.TesterService;
...
/**
 * Main Page of MobileTester
 **/
public class MainPageActivity extends Activity {

	private static final String LOG_TAG = "MobileTester-" + MainPageActivity.class.getSimpleName();
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		btnTest.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				monitorService.setClass(MainPageActivity.this, TesterService.class);
				if (getString(R.string.start_test).equals(btnTest.getText().toString())) {
					...
					Toast.makeText(MainPageActivity.this, getString(R.string.test_result_file_toast) + TesterService.resultFilePath,
		...
		filter.addAction(TesterService.SERVICE_ACTION);
	...
	public boolean onKeyDown(int keyCode, KeyEvent event) {
		if (keyCode == KeyEvent.KEYCODE_BACK) {
			if ((System.currentTimeMillis() - mExitTime) > 2000) {
				...
				Log.d(LOG_TAG, "exit MobileTester");
				finish();
			}
			return true;
		}
