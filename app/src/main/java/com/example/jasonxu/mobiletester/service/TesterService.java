...
import com.example.jasonxu.mobiletester.activity.MainPageActivity;
import com.example.jasonxu.mobiletester.utils.Constants;
import com.example.jasonxu.mobiletester.utils.CpuInfo;
import com.example.jasonxu.mobiletester.utils.CurrentInfo;
import com.example.jasonxu.mobiletester.utils.EncryptData;
import com.example.jasonxu.mobiletester.utils.FpsInfo;
import com.example.jasonxu.mobiletester.utils.MailSender;
import com.example.jasonxu.mobiletester.utils.MemoryInfo;
import com.example.jasonxu.mobiletester.utils.MyApplication;
...
public class TesterService extends Service {
    ...
    private final static String LOG_TAG = "MobileTester-"
            + TesterService.class.getSimpleName();
    ...
    public static final String SERVICE_ACTION = "com.example.jasonxu.mobiletester.service.TesterService";
    ...
    public void onCreate() {
        ...
        des = new EncryptData("MobileTester");
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        builder.setContentIntent(contentIntent).setSmallIcon(R.drawable.icon)
                ...
                .setContentTitle("MobileTester");
        startForeground(startId, builder.build());

        pid = intent.getExtras().getInt("pid");
//        uid = intent.getExtras().getInt("uid"); get uid after activity start
    ...
    private void createResultCsv() {
        ...
        if (android.os.Environment.getExternalStorageState().equals(
            ...
            resultFilePath = "/sdcard" + File.separator + "MobileTester_TestResult_"
                    + mDateTime + ".csv";
            // resultFilePath =
            // android.os.Environment.getExternalStorageDirectory() +
            // File.separator + "MobileTester_TestResult_" + mDateTime + ".csv";
        } else {
            resultFilePath = getBaseContext().getFilesDir().getPath()
                    + File.separator + "MobileTester_TestResult_" + mDateTime
                    + ".csv";
        }
        try {
    ...
    private void createFloatingWindow() {
        ...
        wmParams.type = WindowManager.LayoutParams.TYPE_PHONE; //2002   2000+2
        wmParams.flags |= 8;
        ...
        try {
            ...
            while ((line = bufferedReader.readLine()) != null) {
                ...
                if (line.matches(regex)) {
                    ...
                    Toast.makeText(TesterService.this,
...
//            第二个执行方法,onPreExecute()执行完后执行
            ...
            try {
                isSendSuccessfully = MailSender.sendTextMail(sender,
                        ...
                        "MobileTester Performance Test Report", "报告内容 see attachment (PS: Mac用户请用Numbers查看附件)",
                        resultFilePath, receivers);
            } catch (Exception e) {
                e.printStackTrace();
                Toast.makeText(TesterService.this, "There was a problem sending the email.", Toast.LENGTH_LONG).show();
                isSendSuccessfully = false;
            }

//            Mail m = new Mail("capvision_4k@163.com", "a53615583");
//
//            String[] toArr = {"573654699@qq.com","capvision_4k@163.com"};
//            m.setTo(toArr);
//            m.setFrom("capvision_4k@163.com");
...
//            }
    ...
    public void onDestroy() {
        ...
        try {
            ...
            isSendSuccessfully = sTask.execute().get();
        } catch (Exception e) {
            isSendSuccessfully = false;
        }
        if (isSendSuccessfully) {
            ...
            Toast.makeText(
                    ...
                    getString(R.string.send_fail_toast)
                            + TesterService.resultFilePath, Toast.LENGTH_LONG)
                    .show();
        }
        super.onDestroy();
        stopForeground(true);
